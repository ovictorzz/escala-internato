const CACHE_VERSION = 't7a-push-v9';
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async()=>{
    ...
    const css = `<style id="mobile-account-controls-v9">
...
#mobile-menu-stable .mms-account-v9{display:block!important;visibility:visible!important;opacity:1!important;margin-top:8px;padding:11px 2px 2px;border-top:1px solid rgba(148,163,184,.13)}
#mobile-menu-stable .mms-account-v9-title{padding:0 7px 9px;font:800 9px/1 'Outfit',sans-serif;letter-spacing:.15em;text-transform:uppercase;color:#71717a}
#mobile-menu-stable .mms-account-v9-grid{display:grid!important;grid-template-columns:1fr 1fr;gap:7px}
#mobile-menu-stable .mms-account-v9 button{display:flex!important;align-items:center!important;justify-content:center!important;gap:9px!important;min-height:47px;border-radius:13px;border:1px solid rgba(148,163,184,.13);background:rgba(255,255,255,.04);color:#e4e4e7;font:750 12px/1.1 'Outfit',sans-serif;padding:8px}
#mobile-menu-stable .mms-account-v9 .full{grid-column:1/-1}
#mobile-menu-stable .mms-account-v9 .faceid{min-height:52px;color:#7dd3fc;background:linear-gradient(135deg,rgba(14,165,233,.13),rgba(59,130,246,.08));border-color:rgba(56,189,248,.26)}
#mobile-menu-stable .mms-account-v9 .admin{color:#a5b4fc;background:rgba(79,70,229,.12);border-color:rgba(99,102,241,.24)}
#mobile-menu-stable .mms-account-v9 .logout{color:#fb7185;background:rgba(244,63,94,.08);border-color:rgba(244,63,94,.18)}
...
#mobile-menu-stable .mms-faceid-icon{width:20px;height:20px;display:inline-block}
html:not(.dark) #mobile-menu-stable .mms-account-v9 button{color:#334155;background:rgba(15,23,42,.035)}
html:not(.dark) #mobile-menu-stable .mms-account-v9 .faceid{color:#0369a1;background:rgba(14,165,233,.08);border-color:rgba(2,132,199,.18)}
html:not(.dark) #mobile-menu-stable .mms-swatch{border-color:rgba(255,255,255,.95);box-shadow:0 0 0 1px rgba(15,23,42,.12),0 3px 10px rgba(15,23,42,.12)}
    ...
    const js = `<script id="mobile-account-controls-v9-script">
(()=>{
 const irParaLogin=()=>{
  try {
